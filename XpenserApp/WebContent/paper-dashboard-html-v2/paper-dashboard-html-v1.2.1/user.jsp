...
<div class="col-md-12">
                                   <input name="img1" type="file" accept="image/*" onchange="loadFile(event,c)">
...
<!--script>
 var loadFile = function(event) {
  ...
  <button class="btn waves-effect waves-light" type="submit" name="action" id="submit" onclick="submit()">SUBMIT
    <i class="material-icons right"></i>
  </button>
